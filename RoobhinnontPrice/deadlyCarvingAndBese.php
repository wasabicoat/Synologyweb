...
<?  //floatval($priceImage[$_POST[sizeImage]][$index])
	if(isset( $_POST[Back] )){
		...
		$calImagePrice = floatval($priceImage[$_POST[sizeImage]][$index]);
		//echo "รูปราคา : ".$calImagePrice;
		?><br /><?
		echo "ราคาฐานตั้ง 90 องศา";
			...
			?><br /><?
			echo "ขนาดฐาน : ".(string)((floatval($sizeSY)/10*8))." X ".(string)(floatval($sizeSY));
